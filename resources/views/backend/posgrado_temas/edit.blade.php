        ...
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <a class="btn btn-default btn-xs" href="/posgrado_tema/{{$plan->posgrado_id}}"><span class="glyphicon glyphicon"></span> Regresar</a>                                      
                </div>
            </div>
            <div class="panel-body">
            
            <form class="" method="post" class="form" role="form" action="{{route('update_plan_posgrado')}}" enctype="">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="form-group col-lg-12">
                ...
                <input type="hidden" value="{{$plan->posgrado_id}}" name="posgrado_id" id="posgrado_id">
              ...
              <div class="form-group col-lg-12">
                ...
                <input type="text" class="form-control" id="curso" name="cursos" value="{{$plan->cursos}}" required="">                
              </div>
