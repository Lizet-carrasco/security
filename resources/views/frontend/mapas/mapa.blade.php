        ...
        series: [{
            ...
            data: [
                ...
                <?php if($ayacuchoPregrado==0){?>
                    ['pe-ay',],
                <?php }else{?>
                    ['pe-ay',<?php echo $ayacuchoPregrado ?>],
                <?php } ?>

                <?php if($juninPregrado==0){?>
                    ['pe-ju',],
                <?php }else{?>
                    ['pe-ju',<?php echo $juninPregrado ?>],
                <?php } ?>
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <i class="fa fa-map"></i> Mapa de Oferta Educativa - Pregrado (Tema: <b>{{$tema->nombre}}</b>)
